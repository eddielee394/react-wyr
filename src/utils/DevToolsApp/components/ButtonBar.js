  ...
  render() {
    ...
    return (
      <div style={styles.buttonBar}>
        {isRedux && <RecordButton paused={this.props.liftedState.isPaused} />}
        {isRedux && <LockButton locked={this.props.liftedState.isLocked} />}
        ...
        {!this.props.noSettings && (
          <Button Icon={SettingsIcon} onClick={this.openSettings}>
            Settings
          </Button>
        )}
